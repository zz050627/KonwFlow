...
2. 在欢迎界面选择 "Open"
3. 选择 `E:\23183\Documents\github\ragent\backend\pom.xml`
...
**方法A：使用运行配置**
1. 右上角运行配置下拉菜单选择 "RagentApplication"
2. 点击运行按钮

**方法B：直接运行主类**
1. 打开 `backend/bootstrap/src/main/java/com/nageoffer/ai/ragent/RagentApplication.java`
2. 右键 → Run 'RagentApplication.main()'
...
### Q: 提示 "Cannot resolve symbol 'RagentApplication'"
