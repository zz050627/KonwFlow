...
### 1.1 KnowledgeBaseDO
**表名**：`t_knowledge_base`  
**路径**：`bootstrap/src/main/java/com/nageoffer/ai/knowflow/knowledge/dao/entity/KnowledgeBaseDO.java`
...
**路径**：`bootstrap/src/main/java/com/nageoffer/ai/knowflow/knowledge/dao/entity/KnowledgeDocumentDO.java`
...
**路径**：`bootstrap/src/main/java/com/nageoffer/ai/knowflow/knowledge/dao/entity/KnowledgeChunkDO.java`
...
### 1.4 UserDO
**表名**：`t_user`  
**路径**：`bootstrap/src/main/java/com/nageoffer/ai/knowflow/user/dao/entity/UserDO.java`
...
### 1.5 RagTraceTaskDO
**表名**：`t_rag_trace_task`  
**路径**：`bootstrap/src/main/java/com/nageoffer/ai/knowflow/rag/dao/entity/RagTraceTaskDO.java`
...
### 1.6 RagTraceNodeDO
**表名**：`t_rag_trace_node`  
**路径**：`bootstrap/src/main/java/com/nageoffer/ai/knowflow/rag/dao/entity/RagTraceNodeDO.java`
...
## 2. 数据传输对象（DTO�?
### 2.1 ChatRequest
**路径**：`framework/src/main/java/com/nageoffer/ai/knowflow/framework/convention/ChatRequest.java`
...
### 2.2 ChatMessage
**路径**：`framework/src/main/java/com/nageoffer/ai/knowflow/framework/convention/ChatMessage.java`
...
### 2.3 RewriteResult
**路径**：`bootstrap/src/main/java/com/nageoffer/ai/knowflow/rag/core/rewrite/RewriteResult.java`
...
**路径**：`bootstrap/src/main/java/com/nageoffer/ai/knowflow/rag/dto/SubQuestionIntent.java`
...
**路径**：`bootstrap/src/main/java/com/nageoffer/ai/knowflow/rag/dto/RetrievalContext.java`
...
### 2.6 Chunk（分块数据）
**路径**：`bootstrap/src/main/java/com/nageoffer/ai/knowflow/core/chunk/VectorChunk.java`
...
**路径**：`infra-ai/src/main/java/com/nageoffer/ai/knowflow/infra/config/AIProviderConfig.java`
...
**路径**：`infra-ai/src/main/java/com/nageoffer/ai/knowflow/infra/config/ModelCandidateConfig.java`
